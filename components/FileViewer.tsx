  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      >
        ...
        <span style={{ marginLeft: "auto" }}>{ext || t("fileViewer.image")}</span>
      ...
      >
        {error ? (
          ...
          <img
            ...
            onError={() => setError(t("fileViewer.failedToLoadImage"))}
            style={{
              maxWidth: "100%",
              maxHeight: "100%",
              objectFit: "contain",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden" }}>
      ...
      >
        ...
        <span style={{ marginLeft: "auto" }}>{ext || t("fileViewer.audio")}</span>
      ...
      >
        <div style={{ width: "min(680px, 100%)" }}>
          ...
          <audio
            ...
            onError={() => setError(t("fileViewer.failedToLoadAudio"))}
            style={{ width: "100%" }}
          />
        </div>
      </div>
      ...
      >
        ...
        {hasDiff && (
          <div style={{ display: "flex", borderRadius: 5, overflow: "hidden", border: "1px solid var(--border)" }}>
            ...
            >
              {t("fileViewer.diff")} {changeCount > 0 && <span style={{ color: "#4ade80", marginLeft: 2 }}>+{changeCount}</span>}
            </button>
          </div>
        )}
